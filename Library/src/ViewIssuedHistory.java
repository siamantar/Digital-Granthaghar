...
public class ViewIssuedHistory extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewIssuedHistory frame = new ViewIssuedHistory();
	...
	public ViewIssuedHistory() {
		...
		String data[][]=null;
		String column[]=null;
		String dTable= "issuehistory";
		String sql = "select * from "+ dTable;
		try(Connection con = DB.getConnection();
		        Statement psh  = con.createStatement();
		        ResultSet rs  = psh.executeQuery(sql) ){
		...
		lblNewLabel = new JLabel("Issued Books History");
